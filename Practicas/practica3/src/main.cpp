...
int main(int argc, char *argv[]) {
    ...
    if(argc!=3) {
        cout << "Introduce el nombre del fichero de entrada <ficheroEntrada> y el número de simulaciones <n>" << endl;
        cout << "Uso main <ficheroEntrada> <n>" << endl;
        exit(1);
    }
    ...
    realizar_bootstraps(carreteras,intersecciones,C,A,n_simulaciones,L_A,R_A); // Bootstraps para el almacen A
    realizar_bootstraps(carreteras,intersecciones,C,B,n_simulaciones,L_B,R_B); // Bootstraps para el almacen B
